...
using DickinsonBros.RollerCoaster.AccountAPII.View.Controllers;
...
namespace DickinsonBros.RollerCoaster.AccountAPII.View.Tests.Controllers
{
    [TestClass]
    public class AccountControllerTests : BaseTest
    {
            ...
            (
                async (serviceProvider) =>
                {
                    ...
                    jwtServiceMock
                        .Setup
                        (
                            jwtService => jwtService.GenerateJWT(It.IsAny<string>(), It.IsAny<System.DateTime>(), false)
                        )
                        .Returns
                        (
                            expectedAccessToken
                    ...
                    jwtServiceMock
                        .Setup
                        (
                            jwtService => jwtService.GenerateJWT(It.IsAny<string>(), It.IsAny<System.DateTime>(), true)
                        )
                        .Returns
                        (
        ...
        [TestMethod]
        public void GetNewJWTTokens_Runs_ReturnsJWTResponse()
        {
